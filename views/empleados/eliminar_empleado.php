...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="card p-4">
            <h2 class="card-title">Eliminar Empleado</h2>
            <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['eliminar'])) {
                $eliminar = eliminarEmpleado($empleadoId);
            ...
            <?php if ($empleado) : ?>
                <p>¿Estás seguro de que deseas eliminar el siguiente empleado?</p>
                <p><strong>ID:</strong> <?php echo $empleado['ID_Empleado']; ?></p>
                <p><strong>Nombre Completo:</strong> <?php echo $empleado['NombreCompleto']; ?></p>
                <p><strong>Cargo:</strong> <?php echo $empleado['Cargo']; ?></p>
                <p><strong>Salario:</strong> <?php echo $empleado['Salario']; ?></p>
                <p><strong>Fecha de Contratación:</strong> <?php echo $empleado['FechaContratacion']; ?></p>

                <form method="post">
                    <button type="submit" name="eliminar" class="btn btn-danger">Eliminar Empleado</button>
                </form>
                <br>
