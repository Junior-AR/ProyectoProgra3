...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="card p-4 mx-auto col-md-8">
            <h2 class="card-title">Eliminar Proveedor</h2>
            <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['eliminar'])) {
                $eliminar = eliminarProveedor($proveedorId);
            ...
            <?php if ($proveedor) : ?>
                ...
                <form method="post">
                    <button type="submit" name="eliminar" class="btn btn-danger">Eliminar Proveedor</button>
                </form>
                <br>
