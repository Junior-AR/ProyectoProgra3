        ...
        <div class="card p-4">
            ...
            <div class="table-container">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($facturas as $factura) {
                                ...
                                echo '<td>' . $factura['NombreProducto'] . '</td>';
                                echo '<td>' . $factura['FechaFactura'] . '</td>';
                                echo '<td>' . $factura['MontoTotal'] . '</td>';
                                echo '<td>
                                  <a class="btn btn-primary btn-sm" href="ver_factura.php?id=' . $factura['ID_Factura'] . '">Ver Detalles</a>
                                  <a class="btn btn-warning btn-sm" href="editar_factura.php?id=' . $factura['ID_Factura'] . '">Editar</a>
                                  <a class="btn btn-danger btn-sm" href="eliminar_factura.php?id=' . $factura['ID_Factura'] . '">Eliminar</a>
                              </td>';
                                echo '</tr>';
                            }
                            ?>
                ...
                <div class="mt-3 text-end">
                    <a class="btn btn-success btn-sm" href="agregar_factura.php">Agregar Factura</a>
                </div>
            </div>
        </div>
    </div>
