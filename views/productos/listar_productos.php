...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="card p-4">
            ...
            <?php include '../../Controllers/controlador_productos.php'; ?>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($productos as $producto) {
                            ...
                            echo '<td>
                                  <a class="btn btn-primary btn-sm" href="ver_producto.php?id=' . $producto['ID_Producto'] . '">Ver Detalles</a>
                                  <a class="btn btn-warning btn-sm" href="editar_producto.php?id=' . $producto['ID_Producto'] . '">Editar</a>
                                  <a class="btn btn-danger btn-sm" href="eliminar_producto.php?id=' . $producto['ID_Producto'] . '">Eliminar</a>
                              </td>';
                            echo '</tr>';
                        }
                        ?>
            ...
            <div class="mt-3 text-end">
                <a class="btn btn-success btn-sm" href="agregar_producto.php">Agregar Producto</a>
            </div>
        </div>
    </div>
